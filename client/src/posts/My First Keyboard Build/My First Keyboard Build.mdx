...
Building a keyboard allows you to customize every part of the typing experience. Keyboard components vary slightly, but in general, here's what you'll need:
    - A case
    - Keyboard switches
    - A circuit board 
      (also called a PCB)
...
I connected the PCB to my computer to test that the mapping of each key was working correctly using [Via](https://caniusevia.com/). Finally, I put the case back together and installed my keycaps.
